...
if(isset($_GET["insertar"])){
    ...
    $ncomun=$data->ncomun;
        ...
        if(($correo!="")&&($nombre!="") && ($ncomun!="") ){
            
    $sqlEmpleaados = mysqli_query($conexionBD,"INSERT INTO empleados(nombre,correo,ncomun) VALUES('$nombre','$correo','$ncomun') ");
    echo json_encode(["success"=>1]);
        }
    exit();
}
...
if(isset($_GET["actualizar"])){
    ...
    $sqlEmpleaados = mysqli_query($conexionBD,"UPDATE empleados SET nombre='$nombre',correo='$correo',ncomun='$ncomun' WHERE id='$id'");
    echo json_encode(["success"=>1]);
    exit();
}
